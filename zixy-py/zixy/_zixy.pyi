...
class RealVec(BaseVec):
    def copy_slice(self, indexer: slice) -> Self: ...
    def scale_slice(self, indexer: slice, scalar: float) -> None: ...
    def fill_slice(self, indexer: slice, scalar: float) -> None: ...
    def norm_slice(self, indexer: slice, squared: bool) -> float: ...
    @classmethod
...
class ComplexVec(BaseVec):
    def copy_slice(self, indexer: slice) -> Self: ...
    def scale_slice(self, indexer: slice, scalar: complex) -> None: ...
    def fill_slice(self, indexer: slice, scalar: complex) -> None: ...
    def norm_slice(self, indexer: slice, squared: bool) -> float: ...
    @classmethod
...
class Modes(Sized):
    ...
    @classmethod
    def from_fock_space_dim(cls, n: int) -> Self: ...

class ImplArray(Sized):
    def scaled_iadd_real(self, coeffs: RealVec, map: Map, rhs: Self, rhs_coeffs: RealVec, scalar: float) -> None: ...
    def scaled_iadd_complex(self, coeffs: ComplexVec, map: Map, rhs: Self, rhs_coeffs: ComplexVec, scalar: complex) -> None: ...
    def copy_terms_real(self, coeffs: RealVec, nonzero: bool) -> tuple[Self, Map, RealVec]: ...
    def copy_terms_complex(self, coeffs: ComplexVec, nonzero: bool) -> tuple[Self, Map, ComplexVec]: ...
    def collect_terms_real(self, coeffs: RealVec, sum: bool) -> tuple[Self, Map, RealVec]: ...
    def collect_terms_complex(self, coeffs: ComplexVec, sum: bool) -> tuple[Self, Map, ComplexVec]: ...
...
class FermionSprings:
    ...
    def default_n_mode(self) -> int: ...
    def __len__(self) -> int: ...
    def get_ops(self, i: int) -> list[tuple[int, bool]]: ...
...
class NormalFermionOperatorArray(FermionArray):
    ...
    def cmpnt_set_from_spring(self, i: int, source: FermionSprings, spring_index: int) -> None: ...
...
class FermionStateArray(FermionArray):
    ...
    def cmpnt_get_list(self, index: int) -> list[bool]: ...
    def cmpnt_get_set(self, index: int) -> set[int]: ...
    def cmpnt_operator_string_imul(
        self,
        index: int,
        operators: NormalFermionOperatorArray,
        operator_index: int,
    ) -> Sign | None: ...
    def cmpnt_count(self, index: int, bit: bool) -> int: ...
    def refresh_map(self, map: Map) -> None: ...
...
class JordanWignerMapper:
    ...
    def apply_real(
        self, ladder_operators: list[tuple[int, bool]]
    ) -> tuple[QubitPauliArray, RealVec, Map]: ...
